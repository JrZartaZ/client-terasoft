    ...
    return (
        ...
        <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item dropdown no-arrow d-sm-none">
                <span className="nav-link dropdown-toggle" href="#" id="searchDropdown" role="button"
            ...
            <li className="nav-item dropdown no-arrow">
                <span className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                    ...
                    <img className="img-profile rounded-circle" src="img/undraw_profile.svg" alt="icon" />
                </span>
